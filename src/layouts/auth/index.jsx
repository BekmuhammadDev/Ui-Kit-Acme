    ...
    return (
        ...
        <div className="container px-5 py-48 mx-auto flex flex-wrap items-center">
          <div className="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
           <img src="https://cdni.iconscout.com/illustration/premium/thumb/authentication-security-illustration-download-in-svg-png-gif-file-formats--secure-login-password-authentic-verification-pack-crime-illustrations-3240388.png?f=webp" alt="user" />
          </div>
